...
node* newNode(int id, string nama, string telepon) {
	...
	nodeBaru->left = NULL;
	nodeBaru->right = NULL;
	nodeBaru->height = 1; // Tinggi dari node baru pasti 1
	return nodeBaru;
}
...
node* minValueNode(node* nodeAkar) {
	...
	// Mencari node dengan id terkecil di kiri
...
node* deleteNodeAVL(node* nodeAkar, int id) {
	...
	// Jika node akar hanya memiliki salah satu child atau tidak memiliki child sama sekali
		...
		printf("Data dengan id %d sudah terhapus.\n", id);
	}
...
int main() {
	...
	rootBST = insertBST(rootBST, 2201, "Nina", "0812345"); rootBST = insertBST(rootBST, 2202, "Nani", "0842345"); rootBST = insertBST(rootBST, 2210, "Nasywa", "0816345");
	...
	rootBST = insertBST(rootBST, 2230, "Devin", "0815344"); rootBST = insertBST(rootBST, 2212, "Lulu", "0812326");rootBST = insertBST(rootBST, 2225, "Hasta", "0812455");
	rootBST = insertBST(rootBST, 2215, "Goku", "0815145");
	//Mengisi data awal AVL
	rootAVL = insertAVL(rootAVL, 2201, "Nina", "0812345"); rootAVL = insertAVL(rootAVL, 2202, "Nani", "0842345"); rootAVL = insertAVL(rootAVL, 2210, "Nasywa", "0816345");
	...
	rootAVL = insertAVL(rootAVL, 2230, "Devin", "0815344"); rootAVL = insertAVL(rootAVL, 2212, "Lulu", "0812326");rootAVL = insertAVL(rootAVL, 2225, "Hasta", "0812455");
